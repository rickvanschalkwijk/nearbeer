...
NearBeer is a Android application for finding the Beer nearby.
It uses Google Places and Direction API to get the places and display the route.
...
=======
    ...
    Copyright 2012 CodeFreeze/SupremeCodeMonkeys
